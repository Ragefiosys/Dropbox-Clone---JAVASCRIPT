class DropBoxController {
    ...
    constructor() {
        ...
        this.btnSentFileEl = document.querySelector('#btn-send-file');
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyAdZEYFocmKI14X9NTuoe0Ce3Bs1Ub3QlI",
            authDomain: "dropbox-clone-f9f73.firebaseapp.com",
            databaseURL: "https://dropbox-clone-f9f73.firebaseio.com",
            projectId: "dropbox-clone-f9f73",
            storageBucket: "dropbox-clone-f9f73.appspot.com",
            messagingSenderId: "141819907635",
            appId: "1:141819907635:web:0f993b7cb49bf18f9c1d46"
        };
    ...
    initEvents() {
        ...
        this.btnSentFileEl.addEventListener('click', event => {
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.btnSentFileEl.disabled = true;
    ...
    uploadComplete(){
        ...
        this.btnSentFileEl.disabled = false;
